            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground/80">Get started in minutes</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <Card className="w-full max-w-md border-white/10 bg-white/[0.03] backdrop-blur-xl shadow-2xl mx-2 sm:mx-0">
            ...
            <CardContent className="space-y-3 sm:space-y-4">
              <form onSubmit={handleSignup} className="space-y-3 sm:space-y-4">
                ...
                <div className="space-y-1.5 sm:space-y-2">
                  <label className="text-xs sm:text-sm font-medium">Work Email</label>
                  <div className="relative">
                ...
                <div className="space-y-1.5 sm:space-y-2">
                  ...
                  <div className="relative">
                    <Building className="absolute left-2.5 sm:left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                    <Input
                      type="text"
                ...
                <div className="flex items-center gap-2 text-xs sm:text-sm">
                  <input type="checkbox" className="rounded border-white/20 bg-white/5 h-3.5 w-3.5 sm:h-4 sm:w-4" required />
              ...
              <div className="grid grid-cols-2 gap-2.5 sm:gap-3">
                <Button variant="outline" className="h-10 sm:h-12 border-white/10 hover:bg-white/5 text-xs sm:text-base">
            ...
            <CardFooter className="flex flex-col space-y-3 sm:space-y-4 pt-2 sm:pt-0">
              <p className="text-xs sm:text-sm text-center text-muted-foreground">
                ...
                <Link href="/login" className="text-blue-400 hover:text-blue-300 font-medium transition-colors text-xs sm:text-sm">
                  Sign in
                </Link>
              </p>
